    ...
    <div class="shop-stuff-container">
        <?php foreach ($terms as $term) : ?>
            <div class="shop-stuff">
                <img class="shop-stuff-icon"
                     src="<?php echo get_template_directory_uri() ?>/images/product-type-icons/<?php echo $term->slug ?>.svg">
                <p>
                    <?php echo $term->description; ?>
                </p>
                <p>
                    <a class="shop-stuff-button" href="<?php echo get_term_link($term); ?>"> <?php echo $term->name; ?>
                        Stuff
                    </a>
                </p>
            </div>
