...
function inhabitent_scripts()
{
    ...
    wp_enqueue_script('inhabitent-header-search', get_template_directory_uri() . '/build/js/headersearch.min.js',
        array('jquery'), '', true);

    //add font awesome -- FIND the CDN
...
/**
 * Changes header in front and about pages.
 */
